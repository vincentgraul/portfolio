        ...
        children: (
          <Container ref={containerRef}>
            ...
            <Slider ref={slider} {...sliderSettings}>
              <Slide>
                <Screen src="/img/countries-quiz/home.png" />
              </Slide>

              <Slide>
                <Screen src="/img/countries-quiz/flags.png" />
              </Slide>

              <Slide>
                <Screen src="/img/countries-quiz/capitales.png" />
              </Slide>

              <Slide>
                <Screen src="/img/countries-quiz/score.png" />
              </Slide>
            </Slider>
...
const Screen = styled.img`
  max-width: ${Breakpoints.isTabletOrLower() ? "100%" : "50%"};
  margin: 0 auto;
`;
